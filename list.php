...
<?
// 전체 게시물 수 파악하기
$pndata = mysqli_query($conn, "SELECT no FROM center;");
...
<div id="boardlist" class="mt-2">
    ...
    <div id="boardcont">
        <ul class="list-group my-2">
            ...
            $data = mysqli_query($conn, "SELECT * FROM center ORDER BY no DESC LIMIT $start, $postperpage;");
    ...
    <div id="boardpagi">
        <ul class="pagination justify-content-center">
            ...
            echo "<a class='page-link' href='?page=$prevblock'>";
            ...
            for($j=0; $j<$pageperblock; $j++){
                ...
                if($pnum <= $totalpage){
                    if($pnum == $curpage){
                        ...
                        $pactive = "";
                        $plink = "list.php?page=$pnum";
                    }
                    echo "<li class='page-item $pactive'>";
                        echo "<a href='list.php?page=$pnum' class='page-link'>";
                            echo $pnum;
                        echo "</a>";
                    echo "</li>";
                }
            ...
            echo "<a class='page-link' href='?page=$nextblock'>";
